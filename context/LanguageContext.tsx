...
const translations = {
  es: {
    ...
    "businesses.subtitle": "Administra los negocios registrados en el sistema.",
    ...
    "businesses.modal.text": "Introduce el nombre del nuevo negocio.",
    ...
    "businesses.form.error.required": "El nombre es obligatorio.",
    "businesses.form.error.create": "Error al crear el negocio.",
    "businesses.delete.title": "Eliminar negocio",
    "businesses.delete.text": "¿Seguro que quieres eliminar el negocio?",
    "businesses.delete.action": "Eliminar",
    "businesses.form.success.create": "Negocio creado con éxito.",
    "businesses.form.success.delete": "Negocio eliminado con éxito.",
  ...
  en: {
    ...
    "businesses.subtitle": "Manage businesses registered in the system.",
    ...
    "businesses.modal.text": "Enter the name of the new business.",
    ...
    "businesses.form.error.required": "Name is required.",
    "businesses.form.error.create": "Error creating business.",
    ...
    "businesses.form.success.create": "Business created successfully.",
    "businesses.form.success.delete": "Business deleted successfully.",
